...
return {
  ...
  --- { Restart rust-analyzer
      --
      -- Use :RestartRustAnalyzer to quickly restart the rust-analyzer
      -- instance started by the Neovim's native language server
      -- integration. Thanks GPT-4!
      ...
      --   vim.api.nvim_echo({
      --     {"Rust Analyzer has been restarted successfully.", "Normal"}
      --   }, false, {})
      -- end
      -- vim.api.nvim_create_user_command(
      --   'RestartRustAnalyzer', RestartRustAnalyzer, {}
      -- )
  --- }
  ...
  --- { nvim-lspconfig General
      ...
      --
      -- Need loadOutDirsFromCheck for compiled .proto files
      -- (confirmed err o.w.)
      ...
      --       },
      --       diagnostics = {
      --         -- Prevents cfg'd code from being all underlined
      --         -- as warning
  ...
  --- { Old nvim LSP code navigation shortcuts, other settings
      ...
      -- https://github.com/sharksforarms/vim-rust/blob/master/
      -- neovim-init-lsp-cmp-rust-tools.vim
      --
      ...
      --   { silent = true })
      -- vim.keymap.set("n", "<LocalLeader>f", vim.lsp.buf.references,
      --   { silent = true })
      ...
      --   { silent = true })
      --
      -- vim.api.nvim_create_augroup("auto_set_inlay_hints",
      --   { clear = true })
